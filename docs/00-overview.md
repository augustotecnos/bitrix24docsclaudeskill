---
description: Overview of Bitrix24 REST API capabilities and use cases
methods: []
pages: 1
title: Overview of Bitrix24 REST API capabilities and use cases
---
# Overview of Bitrix24 REST API capabilities and use cases
> Overview of Bitrix24 REST API capabilities and use cases
> **1 pages** | Source: apidocs.bitrix24.com

## Table of Contents
- [How Bitrix24 REST API can be used](#how-bitrix24-rest-api-can-be-used)

---

## How Bitrix24 REST API can be used

**Source:** https://apidocs.bitrix24.com/developing-with-rest-api

How Bitrix24 REST API can be used | Bitrix24 REST API and Marketplace Applications
...
Automation Rules and Triggers in CRM
Automation rules
in CRM can automatically send e-mails to clients after certain events, such as after registration on the website or a purchase.
Triggers
can activate automation rules when the status of documents or orders changes in external systems.
...
Workflow Actions
Workflow actions
automate the approval of documents: leave requests, invoice approvals, and other standard procedures. This reduces the time spent on processing requests and improves organizational efficiency within the company.
Developers can integrate actions with external systems, such as time tracking or project management systems.
Smart Scripts in Automation Rules
Smart Scripts in Automation Rules
Smart scripts
offer even more flexible automation. This low-code application allows you to set a sequence of actions for automation rules. The automation rules will pass parameters and report intermediate results of individual actions.
...
REST API Event Handlers
Event handlers
respond to actions in the Bitrix24 system: adding a new contact or changing data in a deal.
...
Create Chatbots
Chatbots
are used in both internal and external communications.
...
Custom Open Line Connectors
Custom Open Line Connectors
Messages from clients in messengers can come into your Bitrix24. WhatsApp, Telegram, Facebook Messenger, or special messengers within marketplaces can be integrated with Bitrix24 using
open line connectors
. This ensures a high level of client engagement and ease of use.
Add Your Own SMS Providers
Add Your Own SMS Providers
You can send SMS from Bitrix24 by connecting an
SMS provider
. This can include notifications about order status, reminders about events, and marketing campaigns. This functionality is especially in demand in regions with limited internet access.
Integrate Telephony
Integrate Telephony
Integrating Bitrix24 with
telephony
automates calls, records conversations, tracks statistics, and automatically creates deals or tasks based on incoming calls. This improves customer service quality and enhances the efficiency of the sales department.
Publish Business Content
Publish Business Content
Use ready-made templates for
landing pages, websites, and online stores
...
Standard Document Templates
Standard Document Templates
These simplify the creation of contracts, invoices, estimates, and other business documents.
Templates
help standardize document flow and reduce the likelihood of errors. Standard templates will be useful for sales departments, legal, and financial services.
Integrations with Payment Systems and Delivery Services
Integrations with Payment Systems and Delivery Services
...
Integrations with Payment Systems
Integrations with Payment Systems
Clients will be able to pay for purchases through convenient
payment methods
: credit cards, electronic wallets, and online banking. This is important for online stores, online course platforms, and booking services.
Integrations with Delivery Services
Integrations with Delivery Services
Integration with
delivery services
allows for the automation of delivery cost calculations, tracking packages, and managing orders. This improves customer service quality and optimizes logistics processes.
...
Expanding Existing Functionality of Bitrix24 Tools with Widget Integrations
Expanding Existing Functionality of Bitrix24 Tools with Widget Integrations
Built-in solutions in the Bitrix24 interface significantly expand functionality. You can
add new widgets
, analytics tools, dashboards, and much more. This approach improves user experience, optimizes workflows, and increases overall productivity when working with the system.
Widgets in CRM
Widgets in CRM
